...
def WV3_PS_Dataloader(root, batch_size):
    ...
    img_scale = 2**11-1
    train_dataset_name = 'training_data/train_wv3.h5'
    train_dataset_path = os.path.join(root, train_dataset_name)
    # val_dataset_name = 'test_data/test_wv3_OrigScale_multiExm1.h5'
    val_dataset_name = 'test_data/test_wv3_multiExm1.h5'
    val_dataset_path = os.path.join(root, val_dataset_name)
    # test_dataset_name = 'test_data/test_wv3_OrigScale_multiExm1.h5'
    test_dataset_name = 'test_data/test_wv3_multiExm1.h5'
    ...
    val_dataset = MultiExmTest_h5(val_dataset_path, val_dataset_name, img_scale)
    val_loader = DataLoader(val_dataset, batch_size=1, shuffle=False)
    test_dataset = MultiExmTest_h5(test_dataset_path, val_dataset_name, img_scale)
    test_loader = DataLoader(test_dataset, batch_size=1, shuffle=False)    
    return train_loader, val_loader, test_loader

def QB_PS_Dataloader(root, batch_size):
    # root = '/hdd/sungpyo/Pan-Sharpening/Pancollection'
    img_scale = 2**11-1
    train_dataset_name = 'training_data/train_qb.h5'
    train_dataset_path = os.path.join(root, train_dataset_name)
    # val_dataset_name = 'test_data/test_qb_OrigScale_multiExm1.h5'
    val_dataset_name = 'test_data/test_qb_multiExm1.h5'
    val_dataset_path = os.path.join(root, val_dataset_name)
    test_dataset_name = 'test_data/test_qb_multiExm1.h5'
    test_dataset_path = os.path.join(root, test_dataset_name)
...
def GF2_PS_Dataloader(root, batch_size):
    # root = '/hdd/sungpyo/Pan-Sharpening/Pancollection'
    img_scale = 2**10-1
    train_dataset_name = 'training_data/train_gf2.h5'
    train_dataset_path = os.path.join(root, train_dataset_name)
    # val_dataset_name = 'test_data/test_gf2_OrigScale_multiExm1.h5'
    val_dataset_name = 'test_data/test_gf2_multiExm1.h5'
    val_dataset_path = os.path.join(root, val_dataset_name)
    # test_dataset_name = 'test_data/test_gf2_OrigScale_multiExm1.h5'
...
def WV2_PS_Dataloader(root, batch_size):
    # root = '/hdd/sungpyo/Pan-Sharpening/Pancollection'
    img_scale = 2**11-1
...
if __name__ == '__main__':
    ...
    img_scale = 2**11-1
    train_dataset_path = '/hdd/sungpyo/Pan-Sharpening/Pancollection/training_data/train_wv3.h5'
    test_dataset_name = 'test_data/test_wv3_OrigScale_multiExm1.h5'
