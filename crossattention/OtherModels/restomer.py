...
class Restormer(nn.Module):
    def __init__(self, ms_channels = 8, num_blocks=[2, 3, 3, 4], num_heads=[1, 2, 4, 8], channels=[8*3, 16*3, 32*3, 64*3], num_refinement=4,
                 expansion_factor=2.66):
        super(Restormer, self).__init__()

        self.embed_conv = nn.Conv2d(ms_channels+1, channels[0], kernel_size=3, padding=1, bias=False)
        ...
        self.output = nn.Conv2d(channels[1], ms_channels, kernel_size=3, padding=1, bias=False)
